...
// color of the search icon background

function App() {
  return (
    <div className="App">
      <div className='static_main_header'>
        <div className='top_div'>

          <div className='amazone_image'>
            <img
          ...
          <div className='deliver_location'>
            <div className='with_img'>
              <img src='./Home_pngs/location_icon.png' alt='' />
            </div>
            <div className='with_text'>
              <h5>Deliver to</h5>
              <h3>Kenya</h3>
            </div>
          </div>
